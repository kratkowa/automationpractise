...
Sending Message With Invalid Email Address
    [Documentation]  Sending message to the service using not existing email address
...
#wpisuje nieprawidłowego maila
    Input Text      xpath=/html/body/div/div[2]/div/div[3]/div/form/fieldset/div[1]/div[1]/p[4]/input  text=xyzol
